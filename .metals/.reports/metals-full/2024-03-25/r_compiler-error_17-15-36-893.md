...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnWest, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST &&currentRobot.name().equals("SRUP")));
    DetecState.addNext(STTurnWe@@st, () -> detectWall() && isSameDirection(getHeading(), Parameters.NORTH));
    ...
    STTurnWest.addNext(DetecState, () -> isSameDirection(getHeading(),  -Math.PI) );
