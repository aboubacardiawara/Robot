...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnNorth, () -> detectWall() && isSameDirection(getHeading(), Parameters.NORTH));
    DetecState.addNext(STTurnWest, () -> detectWall() && isSameDir@@ection(getHeading(), Parameters.NORTH) && currentRobot == Robots.SRUP);
