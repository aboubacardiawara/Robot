...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnEast, () -> detectWall() && isSameDirection(getHeadi@@ng(), Parameters.WEST));
    STTurnWest.addNext(DetecState, () -> isSameDirection(getHeading(), 2 *Math.PI));
