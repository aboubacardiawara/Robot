...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnWestSup, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST) && this.currentRobot.name().equals("SRUP"));
    DetecState.addNext(STTurnWestSRDOWN, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST) && th@@is.currentRobot.name().equals("SRDOWN"));
