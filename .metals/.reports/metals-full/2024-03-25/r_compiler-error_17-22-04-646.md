...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnWestSup, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST) && this.currentRobot.name().equals("SR@@UP"));
    DetecState.addNext(STTurnWestSRDOWN, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST) && this.currentRobot.name().equals("SRDOWN"));
