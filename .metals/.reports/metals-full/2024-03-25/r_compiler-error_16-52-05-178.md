...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnEast, () -> detectWall() && isSameD@@irection(getHeading(), Parameters.SOUTH));
    ...
    STTurnEast.addNext(DetecState, () -> isSameDirection(getHeading(), - 3*Math.PI/2));
