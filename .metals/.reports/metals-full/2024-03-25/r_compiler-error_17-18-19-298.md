...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnWestSup, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST) && currentRobot.name().equals("SRUP"));
    DetecState.addNext(STTurnWestSRDOWN, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST) &&currentRobot.name().equals("SRDOWN"));
    DetecState.addNext(STTurnWest, () -> detectWall() && isSameDirection(getHeading(), Parameters.NORTH));
    DetecState.addNext(STTurnEast, () -> detectWall() && isSameDirection(getHeadi@@ng(), Parameters.SOUTH));
