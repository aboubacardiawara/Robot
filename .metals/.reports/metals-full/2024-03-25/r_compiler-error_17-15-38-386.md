...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    //Detect wall faire le tour du tera@@in et non pas des aller retour 
    DetecState.addNext(STTurnWestS, () -> detectWall() && isSameDirection(getHeading(), Parameters.EAST &&currentRobot.name().equals("SRUP")));
