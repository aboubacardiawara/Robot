...
public class HunterSecondary extends SecondaryBotBaseBrain {
  ...
  protected IState buildStateMachine() {
    ...
    DetecState.addNext(STTurnWest, () -> detectWall() && isSameDi@@rection(getHeading(), Parameters.NORTH));
    ...
    STTurnWestSRDOWN.addNext(DetecState, () -> isSameDirection(getHeading(),  Math.PI/2) );
    STTurnWestSRDOWN.setStateAction(null);
