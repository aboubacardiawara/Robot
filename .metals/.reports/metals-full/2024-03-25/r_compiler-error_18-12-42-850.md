file://<WORKSPACE>/src/algorithms/hunters/HunterMain.java
...
action parameters:
offset: 3581
uri: file://<WORKSPACE>/src/algorithms/hunters/HunterMain.java
text:
```scala
...
import algorithms.hunters.brains.core.MainBotBaseBrain;
import algorithms.hunters.brains.core.BaseBrain.Robots;
import algorithms.hunters.brains.core.dto.Const;
import algorithms.hunters.brains.core.dto.Position;
import algorithms.hunters.brains.core.dto.RobotState;
...
public class HunterMain extends MainBotBaseBrain {
    ...
    protected IState buildStateMachine() {
        ...
        initState.addNext(MoveState, () -> isSameDirecti@@on(getHeading(), initStateAngleTarget));
