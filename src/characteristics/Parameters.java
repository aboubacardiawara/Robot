...
public class Parameters {
  ...
  public static final Class<? extends IBrain> teamAMainBotBrainClass = MainBotBrain.class; // class given by name; is
                                                                                           // supposed to extends
                                                                                           // robotsimulator.Brain
  public static final String teamAMainBotAvatar = "avatars/cyclope.png"; // path relative to location of ant build.xml
                                                                         // file
  public static final double teamAMainBotRadius = 50, // 1 unit = 1mm, body radius
      ...
      teamAMainBotFrontalDetectionAngle = 0, // UNUSED AT THE MOMENT, frontal sensor detection angle is suppoed to be
                                             // absolute
      teamAMainBotSpeed = 5, // 1 unit = 1mm, distance performed at step movement
  ...
  public static final Class<? extends IBrain> teamASecondaryBotBrainClass = SecondaryBotBrain.class; // class given by
                                                                                                     // name;
  // is supposed to
  // extends
  // robotsimulator.Brain
  ...
  public static final double teamASecondaryBotRadius = 50, // 1 unit = 1mm, body radius
      ...
      teamASecondaryBotFrontalDetectionAngle = 0, // UNUSED AT THE MOMENT, frontal sensor detection angle is suppoed to
                                                  // be absolute
      ...
      teamASecondaryBot1InitHeading = EAST, // clockwise trigonometric unit, according to screen pixel coordinate
                                            // reference
      ...
      teamASecondaryBot2InitHeading = EAST; // clockwise trigonometric unit, according to screen pixel coordinate
                                            // reference
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.BrainCanevas"; // class given by name; is supposed
                                                                                     // to extends robotsimulator.Brain
  public static final String teamBMainBotAvatar = "avatars/hollowee.png"; // path relative to location of ant build.xml
                                                                          // file
  public static final double teamBMainBotRadius = 50, // 1 unit = 1mm, body radius
      ...
      teamBMainBotFrontalDetectionAngle = 0, // UNUSED AT THE MOMENT, frontal sensor detection angle is suppoed to be
                                             // absolute
      teamBMainBotSpeed = 5, // 1 unit = 1mm, distance performed at step movement
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.BrainCanevas"; // class given by name; is
                                                                                          // supposed to extends
                                                                                          // robotsimulator.Brain
  public static final String teamBSecondaryBotAvatar = "avatars/fannyExplorer.png"; // path relative to location of ant
                                                                                    // build.xml file
  public static final double teamBSecondaryBotRadius = 50, // 1 unit = 1mm, body radius
      ...
      teamBSecondaryBotFrontalDetectionAngle = 0, // UNUSED AT THE MOMENT, frontal sensor detection angle is suppoed to
                                                  // be absolute
      ...
      teamBSecondaryBot1InitHeading = WEST, // clockwise trigonometric unit, according to screen pixel coordinate
                                            // reference
      ...
      teamBSecondaryBot2InitHeading = WEST; // clockwise trigonometric unit, according to screen pixel coordinate
                                            // reference
